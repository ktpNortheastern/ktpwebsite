...
export default function Statement() {
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle,rgba(255,255,255,0.9)_0.5px,transparent_0.5px)] bg-[length:8px_8px] [mask-image:linear-gradient(to_bottom,transparent,black_45%)]"
      />
      <ScrambleText
        as="h2"
