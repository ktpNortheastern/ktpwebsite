...
// each gap below is a tight, explicit mt-2 instead of a blank line rendered
// at the body's own line-height, which across 8 paragraph breaks was by
// itself enough to push the letter past one screen.
  ...
  return (
    ...
    >
      ...
      <div className="md:max-w-[622px]">
        <ScrambleText
          as="h2"
          text="Presidential Welcome"
          className="font-mono text-2xl font-bold text-white"
        />
        <div className="mt-3 flex flex-col gap-2 font-sans text-sm leading-snug text-white/80">
